 ...
 */
var CustomSelect = function(options, nonDocumentElement = null) {
  // console.log("elem is: ")
  // console.log(options.elem)
  var elem;
  if (nonDocumentElement != null) {
    // console.log("nonDocumentElement is: ");
    // console.log(nonDocumentElement);
    // console.log(nonDocumentElement.querySelector(options.elem + ""));
    elem =
    nonDocumentElement,
   ...
   */
  function onClick(e) {
    if (this.classList.contains("inactiveNode")) {
      return;
    }
    e.preventDefault();
